...
(1,'Starry Night','Post-Impressionism','Oil on Canvas',NULL,'A vibrant night sky over a small town',0,NULL,NULL,450000,1),
(2,'Sunflowers','Post-Impressionism','Oil on Canvas',NULL,'Vibrant sunflowers in a vase',0,NULL,NULL,300000,1),
(3,'Guernica','Cubism','Oil on Canvas',NULL,'A powerful political statement on the tragedies of war',0,NULL,NULL,500000,2),
(4,'The Weeping Woman','Cubism','Oil on Canvas',NULL,'A depiction of sorrow and pain',0,NULL,NULL,350000,2),
(5,'Mona Lisa','High Renaissance','Oil on Wood',NULL,'The most famous portrait with an enigmatic smile',0,NULL,NULL,400000,3),
(6,'The Last Supper','High Renaissance','Mural',NULL,'Iconic religious scene with dramatic composition',0,NULL,NULL,480000,3),
(7,'Water Lilies','Impressionism','Oil on Canvas',NULL,'A series of approximately 250 oil paintings of water lilies',0,NULL,NULL,320000,4),
(8,'Impression, Sunrise','Impressionism','Oil on Canvas',NULL,'The painting that led to the name of the Impressionist movement',0,NULL,NULL,280000,4),
(9,'The Persistence of Memory','Surrealism','Oil on Canvas',NULL,'A surreal landscape with melting clocks',0,NULL,NULL,450000,5),
(10,'Swans Reflecting Elephants','Surrealism','Oil on Canvas',NULL,'A classic example of Dalí’s double images',0,NULL,NULL,410000,5),
(11,'Blue and Green Music','Modernism','Oil on Canvas',NULL,'An abstract blend of color suggesting musical rhythm',0,NULL,NULL,270000,6),
(12,'Red Canna','Modernism','Oil on Canvas',NULL,'Vibrant depiction of a red flower, showcasing O’Keeffe’s distinctive style',0,NULL,NULL,260000,6),
(13,'The Two Fridas','Surrealism','Oil on Canvas',NULL,'A double self-portrait representing Frida’s dual heritage',0,NULL,NULL,350000,7),
(14,'Self-Portrait with Thorn Necklace and Hummingbird','Surrealism','Oil on Canvas',NULL,'A symbolic self-portrait reflecting personal suffering',0,NULL,NULL,300000,7),
(15,'No. 5, 1948','Abstract Expressionism','Oil on Fiberboard',NULL,'An iconic piece of abstract expressionist art',0,NULL,NULL,480000,8),
(16,'Convergence','Abstract Expressionism','Oil on Canvas',NULL,'A vibrant example of Pollock’s unique drip painting technique',0,NULL,NULL,425000,8),
(17,'Campbel’s Soup Cans','Pop Art','Synthetic Polymer Paint on Canvas',NULL,'A pivotal piece in the development of Pop Art',0,NULL,NULL,390000,9),
(18,'Marilyn Diptych','Pop Art','Acrylic on Canvas',NULL,'Warhol’s famous portrayal of Marilyn Monroe',0,NULL,NULL,460000,9),
(19,'David','Renaissance','Marble Sculpture',NULL,'A masterpiece of Renaissance sculpture by Michelangelo',0,NULL,NULL,500000,10),
(20,'Sistine Chapel Ceiling','Renaissance','Fresco',NULL,'A cornerstone work of High Renaissance art',0,NULL,NULL,490000,10),
(21,'The Night Watch','Baroque','Oil on Canvas',NULL,'A famous 1642 painting by Rembrandt, depicting a city guard',0,NULL,NULL,310000,11),
(22,'The Storm on the Sea of Galilee','Baroque','Oil on Canvas',NULL,'Rembrandt’s only known seascape',0,NULL,NULL,280000,11),
(23,'Girl with a Pearl Earring','Baroque','Oil on Canvas',NULL,'Vermeer’s most famous work, often referred to as the Mona Lisa of the North',0,NULL,NULL,330000,12),
(24,'The Milkmaid','Baroque','Oil on Canvas',NULL,'A depiction of a domestic kitchen maid by Vermeer',0,NULL,NULL,300000,12),
(25,'The Kiss','Symbolism','Oil and Gold Leaf on Canvas',NULL,'Klimt’s iconic piece symbolizing love and intimacy',0,NULL,NULL,470000,13),
(26,'Portrait of Adele Bloch-Bauer I','Symbolism','Oil, Silver, and Gold on Canvas',NULL,'One of Klimts most acclaimed works',0,NULL,NULL,450000,13),
(27,'The Dance','Fauvism','Oil on Canvas',NULL,'Matisse’s vibrant depiction of dancing figures',0,NULL,NULL,320000,14),
(28,'Woman with a Hat','Fauvism','Oil on Canvas',NULL,'A colorful portrait by Matisse, known for its radical use of color',0,NULL,NULL,290000,14),
(29,'The School of Athens','High Renaissance','Fresco',NULL,'Raphael’s masterpiece depicting philosophy, featuring famous thinkers',0,NULL,NULL,480000,15),
(30,'Sistine Madonna','High Renaissance','Oil on Canvas',NULL,'One of Raphael’s most famous Madonnas',0,NULL,NULL,410000,15),
(31,'Judith Beheading Holofernes','Baroque','Oil on Canvas',NULL,'Caravaggio’s dramatic and intense depiction of the biblical story',0,NULL,NULL,350000,16),
(32,'Basket of Fruit','Baroque','Oil on Canvas',NULL,'A still life by Caravaggio, remarkable for its realism',0,NULL,NULL,270000,16),
(33,'The Third of May 1808','Romanticism','Oil on Canvas',NULL,'Goya’s powerful portrayal of the Spanish resistance to Napoleon',0,NULL,NULL,400000,17),
(34,'Saturn Devouring His Son','Romanticism','Oil Mural transferred to Canvas',NULL,'A haunting image by Goya, depicting the myth of Saturn',0,NULL,NULL,360000,17),
(35,'The Scream','Expressionism','Oil, Tempera, and Pastel on Cardboard',NULL,'Munch’s iconic expression of human anxiety',0,NULL,NULL,420000,18),
(36,'Madonna','Expressionism','Oil on Canvas',NULL,'Edvard Munch’s evocative artwork blending sensuality and spirituality',0,NULL,NULL,380000,18),
(37,'Venus of Urbino','Renaissance','Oil on Canvas',NULL,'Titian’s celebrated portrayal of the goddess Venus',0,NULL,NULL,460000,19),
(38,'Assumption of the Virgin','Renaissance','Oil on Canvas',NULL,'A masterpiece by Titian, depicting the Virgin Mary’s ascent to heaven',0,NULL,NULL,440000,19),
(39,'The Basket of Apples','Post-Impressionism','Oil on Canvas',NULL,'A still life by Cézanne, showcasing his unique perspective',0,NULL,NULL,340000,20),
(40,'Mont Sainte-Victoire','Post-Impressionism','Oil on Canvas',NULL,'One of Cézanne’s series of paintings featuring the French mountain',0,NULL,NULL,370000,20),
(41,'The Arnolfini Portrait','Northern Renaissance','Oil on Oak',NULL,'Jan van Eyck’s portrait, known for its intricate detail and symbolism',0,NULL,NULL,310000,1),
(42,'The Ghent Altarpiece','Northern Renaissance','Oil on Wood',NULL,'A large and complex early 15th-century polyptych by van Eyck',0,NULL,NULL,350000,1),
(43,'Melencolia I','Northern Renaissance','Engraving',NULL,'Albrecht Dürer’s famous engraving, rich in symbolism',0,NULL,NULL,270000,2),
(44,'Knight, Death, and the Devil','Northern Renaissance','Engraving',NULL,'Dürer’s remarkable copper engraving depicting a knight’s journey',0,NULL,NULL,290000,2),
(45,'Composition VIII','Abstract Art','Oil on Canvas',NULL,'Kandinsky’s abstract composition, known for its geometric forms',0,NULL,NULL,330000,3),
(46,'On White II','Abstract Art','Oil on Canvas',NULL,'A pioneering abstract work by Kandinsky, emphasizing on form and color',0,NULL,NULL,320000,3),
(47,'The Ballet Class','Impressionism','Oil on Canvas',NULL,'Degas’ depiction of young ballet dancers',0,NULL,NULL,340000,4),
(48,'L’Absinthe','Impressionism','Oil on Canvas',NULL,'A provocative painting by Degas, portraying the loneliness in modern cities',0,NULL,NULL,280000,4),
(49,'The Descent from the Cross','Baroque','Oil on Canvas',NULL,'Rubens’ dramatic Baroque masterpiece',0,NULL,NULL,360000,5),
(50,'The Massacre of the Innocents','Baroque','Oil on Wood',NULL,'A powerful and emotional painting by Rubens',0,NULL,NULL,400000,5),
(51,'I and the Village','Modernism','Oil on Canvas',NULL,'Chagall’s early modernist work, reflecting his Russian-Jewish heritage',0,NULL,NULL,310000,6),
(52,'The Birthday','Modernism','Oil on Canvas',NULL,'Marc Chagall’s romantic portrayal of love and celebration',0,NULL,NULL,290000,6),
(53,'Liberty Leading the People','Romanticism','Oil on Canvas',NULL,'Delacroix’s iconic representation of the French Revolution',0,NULL,NULL,420000,7),
(54,'Death of Sardanapalus','Romanticism','Oil on Canvas',NULL,'A dramatic and vibrant work by Delacroix, depicting the last moments of Sardanapalus',0,NULL,NULL,400000,7),
(55,'The Birth of Venus','Early Renaissance','Tempera on Canvas',NULL,'Botticelli’s famous depiction of the goddess Venus emerging from the sea',0,NULL,NULL,480000,8),
(56,'Primavera','Early Renaissance','Tempera on Panel',NULL,'A complex and allegorical work by Botticelli, full of mythological symbolism',0,NULL,NULL,460000,8),
(57,'The Stone Breakers','Realism','Oil on Canvas',NULL,'Courbet’s groundbreaking painting, portraying the life of common peasants',0,NULL,NULL,320000,9),
(58,'A Burial at Ornans','Realism','Oil on Canvas',NULL,'One of Courbet’s major works, depicting a provincial funeral',0,NULL,NULL,340000,9),
(59,'The Garden of Earthly Delights','Northern Renaissance','Oil on Oak',NULL,'Hieronymus Bosch’s triptych, famous for its detailed and fantastical imagery',0,NULL,NULL,450000,20),
(60,'The Haywain Triptych','Northern Renaissance','Oil on Wood',NULL,'A Bosch masterpiece, depicting a journey from paradise to hell',0,NULL,NULL,430000,10),
(61,'Girl With Balloon','Street Art','Stencil',NULL,'A well-known series of stencil murals depicting a young girl with a red, heart-shaped balloon.',0,NULL,NULL,300000,2),
(62,'The Flower Thrower','Street Art','Stencil',NULL,'Depicts a rioter in throwing a bouquet of flowers.',0,NULL,NULL,350000,2),
(63,'Sunflower Seeds','Contemporary Art','Sculpture',NULL,'Millions of small ceramic sunflower seeds, each hand-painted.',0,NULL,NULL,500000,3),
(64,'Dropping a Han Dynasty Urn','Contemporary Art','Photography',NULL,'A series of three black and white photographs showing Ai dropping a 2000-year-old ceremonial urn.',0,NULL,NULL,200000,3),
(65,'Infinity Mirrored Room','Contemporary Art','Installation',NULL,'A mirror-lined chamber with a dazzling and seemingly endless LED light display.',0,NULL,NULL,1000000,4),
(66,'Pumpkin','Contemporary Art','Sculpture',NULL,'A large sculpture of a pumpkin, adorned with her signature polka dot motif.',0,NULL,NULL,800000,4),
(67,'Balloon Dog','Contemporary Art','Sculpture',NULL,'A series of large sculptures resembling balloon animals, created in stainless steel with mirror-finish surfaces.',0,NULL,NULL,1500000,5),
(68,'Rabbit','Contemporary Art','Sculpture',NULL,'A stainless steel sculpture with a highly reflective surface, shaped like a rabbit.',0,NULL,NULL,900000,5),
(69,'For the Love of God','Contemporary Art','Sculpture',NULL,'A platinum cast of a human skull encrusted with diamonds.',0,NULL,NULL,10000000,6),
(70,'The Physical Impossibility of Death in the Mind of Someone Living','Contemporary Art','Installation',NULL,'A tiger shark preserved in formaldehyde in a vitrine.',0,NULL,NULL,8000000,6);
...
-- Dump completed on 2024-01-20 19:25:46
